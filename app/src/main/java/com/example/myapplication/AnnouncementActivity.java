...
public class AnnouncementActivity extends BaseActivity {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvTitle, tvMessage, tvTime, tvUrgentBadge;
        ...
        ViewHolder(@NonNull View itemView) {
            ...
            tvTime = itemView.findViewById(R.id.tvAnnouncementTime);
        ...
        private void showAnnouncementDetails(Announcement announcement) {
            String details = announcement.getContent() +
                    "\n\n📅 Posted: " + announcement.getDate() + " at " + announcement.getTime();

            if (announcement.getCategory() != null && !announcement.getCategory().isEmpty()) {
                details += "\n📌 Category: " + announcement.getCategory();
            }

            if (announcement.getAuthor() != null && !announcement.getAuthor().isEmpty()) {
